      ...
      <section id="skill" ref={ref} className="section">
        <div className="w-auto h-auto flex flex-col card p-4 md:p-6 lg:p-8 xl:p-16 2xl:p-20">
          ...
          <div className="skills-content">
            <SkillDetail arr={programmingArr} skillTitle="Programming / Mark-up languages"/>
            <SkillDetail arr={frontendArr} skillTitle="Front-end Technologies" />
            ...
            <SkillDetail arr={devOpsArr} skillTitle="DevOps / Cloud / Testing"/>
